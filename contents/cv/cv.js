          ...
          <div className='col-md-9'>
            <div className='row'>
              <div className='col-md-12'>
                <h3><a href='http://www.oneadvanced.com'>Advanced</a></h3>
                <p className='info'>
                  <span className='title'>ERP Architect</span> <span>&bull;</span> <em className='date'>March 2018 - Present</em><br />
                  Key Technologies: Node.js, React, Docker, AWS, Postgres, Progress OpenEdge
                </p>
                <ul>
                  <li>Leading projects with a team of developers in different locations to ensure all functionality is delivered as specified, on time and to a high quality.</li>
                  <li>Mentoring and supporting teams with different skill sets and experience who are located in different locations.</li>
                  <li>Software and database design and implementation on several different technologies i.e. Node.js, React, PostgresSQL, Progress 4GL and MS SQL.</li>
                  <li>Assisting other teams with migration to cloud based systems i.e. on-premise to cloud based on AWS.</li>
                  <li>Research &amp; Development on new functionality/features/technologies including Voice (Alexa/Google Assistant), Chatbots, AI/ML and AR/Augmented Reality</li>
                  <li>Part of the company software architecture team. Involved in deciding how the company moves forward from a technology and architecture point of view. This will impact all teams, totalling 500+ developers and 100+ applications.</li>
                  <li>Part of the company devops community of practice. Involved in helping increase devops awareness, best practice and engagement throughout the company.</li>
                </ul>
                <p className='info'>
                ...
                <ul>
                  ...
                  <li>Database design and implementation on several different database technologies i.e. Progress 4GL, MS SQL and PostgresSQL.</li>
                  <li>Lead in key technical related issues. This includes managing development, build and release environments for the entire team. This was achieved using technologies such as Subversion/Github, Ant, Jenkins, Octopus Deploy, Docker and Amazon AWS. Including external release deployment using Installshield.</li>
                  ...
                  <li>Part of the company software architecture team consisting of 15 individuals. Involved in deciding how the company moves forward from a technology, devops and architecture point of view. This will impact all teams, totalling 500+ developers and 100+ applications.</li>
                  <li>General Application and Hardware support for Development/QA team.</li>
                </ul>
                <p className='info'>
                  <span className='title'>Senior Developer</span> <span>&bull;</span> <em className='date'>November 2010 - November 2012</em><br />
                  Key Technologies: Progress OpenEdge, SQL Server, C#, Java
                </p>
                <ul>
                  <li>Assisting with specifications and coding new modules on a payroll system used to pay hundreds of thousands of people around the UK. This needs to be strictly compliant with HMRC rules and regulations.</li>
                  <li>Database design and implementation on a number of different database technologies including Progress and MSSQL.</li>
                  <li>Dealing with development, build and release environments using subversion. This also includes building releases with Installshield.</li>
                  <li>Analysing maintenance issues and providing a quick and efficient turnaround.</li>
                </ul>
              </div>
            </div>
            <div className='row'>
              <div className='col-md-12'>
                ...
                <p className='info'>Software Engineer <span>&bull;</span> <em className='date'>May 2009 - November 2010</em><br />Key Technologies: C#, ASP.NET, SQL Server</p>
                <ul>
            ...
            <div className='row'>
              <div className='col-md-12'>
                ...
                <p className='info'>Programmer <span>&bull;</span> <em className='date'>June 2006 - May 2009</em><br />Key Technologies: Progress OpenEdge</p>
                <ul>
